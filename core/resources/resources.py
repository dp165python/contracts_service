...
from controllers.controllers import ContractController
...
class ContractListResource(Resource):
    ...
    def post(self):
        ...
        data, errors = Contract.contract_schema.load(request_dict)

        create_contract = ContractController(data, errors).contract_create()
        query = Contract.query.get(create_contract)
